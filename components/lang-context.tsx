...
export const t: Record<string, Record<Lang, string>> = {
  ...
  // Stats
  "stat.avg":   { ko: "타율", en: "AVG" },
  "stat.ops":   { ko: "OPS", en: "OPS" },
  "stat.h":     { ko: "안타", en: "H" },
  "stat.hr":    { ko: "홈런", en: "HR" },
  "stat.rbi":   { ko: "타점", en: "RBI" },
  "stat.obp":   { ko: "출루율", en: "OBP" },
  "stat.slg":   { ko: "장타율", en: "SLG" },
  "stat.era":   { ko: "평자", en: "ERA" },
  "stat.whip":  { ko: "WHIP", en: "WHIP" },
  "stat.k9":    { ko: "K/9", en: "K/9" },
  "stat.so":    { ko: "삼진", en: "SO" },
  "stat.w":     { ko: "승", en: "W" },
  "stat.l":     { ko: "패", en: "L" },
  "stat.d":     { ko: "무", en: "D" },
  "stat.sv":    { ko: "세이브", en: "SV" },
  "stat.hld":   { ko: "홀드", en: "HLD" },
  "stat.ip":    { ko: "이닝", en: "IP" },
  "stat.games": { ko: "경기", en: "G" },
  "stat.pa":    { ko: "타석", en: "PA" },
  "stat.ab":    { ko: "타수", en: "AB" },
  "stat.bb9":   { ko: "BB/9", en: "BB/9" },
  "stat.kbb":   { ko: "K/BB", en: "K/BB" },
  "players.role": { ko: "보직", en: "Role" },
